...
I am a researcher in applied mathematics with a strong interest in combinatorial optimization methods for machine learning problems.
Throughout my projects, I have developed solid expertise in these fields.
...
\cvitem{Mathematical Modelling}{MIP, MINLP, SOCP, LP formulation • Model strengthening strategies • Optimization solvers (Gurobi, Mosek, CPLEX, SCIP, CvxOPT, ...) • Callbacks and lazy updates • Mathematical programming libraries (\texttt{gurobipy}, \texttt{cvxpy}, \texttt{jump}, \texttt{pyomo}, \texttt{pybnb}, \texttt{ampl}, ...)}
